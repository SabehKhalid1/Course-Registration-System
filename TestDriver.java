public class TestDriver {
    ...
    public static void main(String[] args) {
        ...
        //Create students
        Student john = new Student("Jon Maxwell", "100232122");
        Student sarah = new Student("Sarah Lee", "100523332");
        Student emily = new Student("Emily Johnson", "100512132");
        Student alex = new Student("Alex Williams", "100232732");
